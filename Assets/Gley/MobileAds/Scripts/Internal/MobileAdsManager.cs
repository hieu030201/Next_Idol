...
namespace Gley.MobileAds.Scripts.Internal
{
    public class MobileAdsManager : MonoBehaviour
    {
        ...
        public bool continueInitialization;
        ...
        private void ContinueInitialization()
        {
            ...
            // FacilityManager.Instance.OnUserCloseConsentPopup();
            LoadingScene.Instance.OnConsentPopupClosed();
        }
