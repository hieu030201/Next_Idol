    ...
    public class AppLovinImplementation : MonoBehaviour, IAdProvider
    {
            ...
            Vector2Int customSize)
        {
            ...
            switch (position)
            {
                ...
                default:
                    GleyLogger.AddLog(
                        $"Banner Position: {position} not supported by AppLovin, BannerPosition.Top will be used");
                    break;
            }
            ...
            switch (bannerType)
            {
                ...
                default:
                    GleyLogger.AddLog(
                        $"Banner Type: {bannerType} not supported by AppLovin, Default banner behavior will be used");
                    MaxSdk.SetBannerExtraParameter(bannerId, "adaptive_banner", "true");
                    break;
            }
        ...
        private void OnBannerAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
        {
            ...
            FirebaseAnalytics.LogEvent(
                ...
                new Parameter[]
                {
                    new Parameter("ad_unit_id", adUnitId),        // ID quảng cáo
                    new Parameter("error_code", errorInfo.Code.ToString()),      // Mã lỗi
                    new Parameter("ad_type", "banner")         // Loại quảng cáo
                }
            );
        }
        ...
        {
            GleyLogger.AddLog("ad clicked");
            FirebaseAnalytics.LogEvent(
                "ad_click",
                new Firebase.Analytics.Parameter[]
                {
                    new Firebase.Analytics.Parameter("ad_platform", "AppLovin"),
                    new Firebase.Analytics.Parameter("ad_type", adInfo.AdFormat), // Loại quảng cáo (Banner, Interstitial, Rewarded)
                    new Firebase.Analytics.Parameter("ad_unit_id", adUnitId)
                }
            );
            ...
            /*if (FacilityManager.Instance && FacilityManager.Instance.testGameConfig.isShowLog)
            {
                ...
                var log = hour + ":" + minute + " - " + "ad_click" + " : " + adInfo.AdFormat;
                FacilityManager.Instance.AddLog(log);
            }*/
        }

        private void LogAdClickEvent(string adType, string adUnitId)
        {
            // Gửi sự kiện ad_click lên Firebase hoặc hệ thống phân tích
            FirebaseAnalytics.LogEvent(
                "ad_click",
                new Firebase.Analytics.Parameter[]
                {
                    new Firebase.Analytics.Parameter("ad_platform", "AppLovin"),
                    new Firebase.Analytics.Parameter("ad_type", adType), // Loại quảng cáo (Banner, Interstitial, Rewarded)
                    new Firebase.Analytics.Parameter("ad_unit_id", adUnitId)
                }
            );
        }
        ...
        private void OnAdRevenuePaidEvent(string adUnitId, MaxSdkBase.AdInfo impressionData)
        {
            ...
            /*if (FacilityManager.Instance && FacilityManager.Instance.testGameConfig.isShowLog)
            {
                ...
                int hour = currentTime.Hour;     // Giờ (0-23)
                int minute = currentTime.Minute;
                var log = hour + ":" + minute + " - " + "ad_impression" + " : " + impressionData.AdUnitIdentifier;
                FacilityManager.Instance.AddLog(log);
            }*/
        }
        ...
        private void OnInterstitialFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
        {
            ...
            FirebaseAnalytics.LogEvent(
                ...
                new Parameter[]
                {
                    new Parameter("ad_unit_id", adUnitId),        // ID quảng cáo
                    new Parameter("error_code", errorInfo.Code.ToString()),      // Mã lỗi
                    new Parameter("ad_type", "interstitial")         // Loại quảng cáo
                }
            );
            ...
            if (FacilityManager.Instance && FacilityManager.Instance.testGameConfig.isShowLog)
            {
                ...
                int hour = currentTime.Hour;     // Giờ (0-23)
                int minute = currentTime.Minute;
                var log = hour + ":" + minute + " - " + "InterstitialFailed";
                FacilityManager.Instance.AddLog(log);
            }
        }
        ...
        private void LoadAppOpen()
        {
            if (retryNumberAppOpen < maxRetryCount)
            {
                if (LoadingScene.Instance)
                    LoadingScene.Instance.txt4.text = "LoadAppOpen";
        ...
        private void OnRewardedAdFailedEvent(string adUnitId, MaxSdkBase.ErrorInfo errorInfo)
        {
            ...
            FirebaseAnalytics.LogEvent(
                ...
                new Parameter[]
                {
                    new Parameter("ad_unit_id", adUnitId),        // ID quảng cáo
                    new Parameter("error_code", errorInfo.Code.ToString()),      // Mã lỗi
                    new Parameter("ad_type", "rewarded")         // Loại quảng cáo
                }
            );
            ...
            if (FacilityManager.Instance && FacilityManager.Instance.testGameConfig.isShowLog)
            {
                ...
                int hour = currentTime.Hour;     // Giờ (0-23)
                int minute = currentTime.Minute;
                var log = hour + ":" + minute + " - " + "RewardedAdFailed";
                FacilityManager.Instance.AddLog(log);
            }
        }
        ...
        private void OnRewardedAdRevenuePaidEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            GleyLogger.AddLog(
                $"Revenue {revenue} countryCode {countryCode} networkName {networkName} adUnitIdentifier {adUnitIdentifier} placement {placement}");
        }
        ...
        private void LoadMRec(BannerPosition position, Vector2Int customPosition)
        {
            ...
            switch (position)
            {
                ...
                default:
                    GleyLogger.AddLog(
                        $"MRec Position: {position} not supported by AppLovin, AdViewPosition.Top will be used");
                    break;
            }
        ...
        void OnMRecAdLoadedEvent(string adUnitId, MaxSdkBase.AdInfo adInfo)
        {
            ...
            MaxSdk.StartMRecAutoRefresh(mRecId);
