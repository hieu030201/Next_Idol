...
namespace Gley.MobileAds.Internal
{
    ...
    public class AdmobImplementation : MonoBehaviour, IAdProvider
    {
        ...
        private void InitComplete(InitializationStatus status)
        {
            ...
            {
                GleyLogger.AddLog(adapter.Key + " " + adapter.Value.InitializationState + " " +
        ...
        public void ShowBanner(BannerPosition position, BannerType bannerType, Vector2Int customSize,
            Vector2Int customPosition)
        {
        ...
        public void ShowBanner(string bannerID, BannerPosition position, BannerType bannerType, Vector2Int customSize,
            Vector2Int customPosition, bool collapsable)
        {
            bannerLoaded = false;
        ...
        private void LoadBanner(string bannerID, BannerPosition position, BannerType bannerType, Vector2Int customSize,
            Vector2Int customPosition, bool collapsable)
        {
            ...
            switch (bannerType)
            {
                ...
                default:
                    GleyLogger.AddLog(
                        $"Banner Type: {bannerType} not supported by Admob, BannerType.Banner will be used");
                    adSize = AdSize.Banner;
                    break;
            }
            ...
            switch (position)
            {
                ...
                default:
                    GleyLogger.AddLog(
                        $"Banner Position: {position} not supported by Admob, BannerPosition.Top will be used");
                    break;
            }
        ...
        private void BannerLoadSucces()
        {
            ...
            bannerLoaded = true;
            events.TriggerBannerLoadSuccess();
        }
        ...
        private void BannerAdPaid(AdValue adValue)
        {
            ...
            events.TriggerBannerRevenue(adValue.Value, adValue.CurrencyCode);
        }
        ...
        private void BannerFullScreenOpened()
        {
            ...
            events.TriggerBannerDisplaySuccess();
        }
        ...
        private void LoadInterstitial()
        {
            ...
            if (interstitial != null)
            {
                interstitial.OnAdPaid -= InterstitialAdPaid;
        ...
        private void InterstitialLoaded(InterstitialAd ad)
        {
            ...
            events.TriggerInterstitialLoadSuccess();
        }
        ...
        private void InterstitialAdPaid(AdValue adValue)
        {
            ...
            events.TriggerInterstitialRevenue(adValue.Value, adValue.CurrencyCode);
        }
        ...
        private void AdFullScreenOpened()
        {
            ...
            events.TriggerInterstitialDisplaySuccess();
        }
        ...
        private void AdFullScreenFailed(AdError error)
        {
            ...
            events.TriggerInterstitialDisplayFailed(error.ToString());
            InterstitialClosed();
        }
        ...
        private void LoadAppOpen()
        {
            ...
            if (appOpen != null)
            {
                appOpen.OnAdPaid -= AppOpenAdPaid;
        ...
        private void AppOpenAdFullScreenFailed(AdError error)
        {
            ...
            events.TriggerAppOpenDisplayFailed(error.ToString());
            AppOpenClosed();
        }
        ...
        private void AppOpenAdFullScreenOpened()
        {
            ...
            events.TriggerAppOpenDisplaySuccess();
        }
        ...
        private void AppOpenAdPaid(AdValue adValue)
        {
            ...
            events.TriggerAppOpenRevenue(adValue.Value, adValue.CurrencyCode);
        }
        ...
        private void AppOpenLoaded(AppOpenAd ad)
        {
            ...
            events.TriggerAppOpenLoadSuccess();
        }
        ...
        private void RewardedVideoLoaded(RewardedAd ad)
        {
            ...
            events.TriggerRewardedVideoLoadSuccess();
        }
        ...
        private void RewardedPaid(AdValue adValue)
        {
            ...
            events.TriggerRewardedRevenue(adValue.Value, adValue.CurrencyCode);
        }
        ...
        private void RewardedFullScreenOpened()
        {
            ...
            events.TriggerRewardedDisplaySuccess();
        }
        ...
        private void RewardedFullScreenFailed(AdError error)
        {
            ...
            events.TriggerRewardedDisplayFailed(error.ToString());
        ...
        {
            GleyLogger.AddLog(
                $"Rewarded Interstitial Watched -> Reward amount: {reward.Amount} Reward type: {reward.Type}");
        ...
        private void RewardedInterstitialLoaded(RewardedInterstitialAd ad)
        {
            ...
            events.TriggerRewardedInterstitialLoadSuccess();
        }
        ...
        void LogErrorMessage(LoadAdError loadAdError)
        {
            ...
            if (responseInfo != null)
            {
                ...
                {
                    GleyLogger.AddLog(
                        $"{item.AdapterClassName} {item.AdError} {item.AdError.GetMessage()} {item.AdError.GetCode()}");
                }
            }
        }
