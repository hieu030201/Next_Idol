...
namespace Gley.RateGame.Internal
{
    public class StarsPopup : MonoBehaviour
    {
        ...
        public Button send;
        [SerializeField] private Image iconSubmit;

        [SerializeField] [PreviewField(Alignment = ObjectFieldAlignment.Center)]
        private List<Sprite> listIconSubmit;
        ...
        private void Start()
        {
            iconSubmit.sprite = listIconSubmit[0];
            iconSubmit.gameObject.GetComponent<UIButton>().interactable = false;
        ...
        public void StarClicked(GameObject star)
        {
            ...
            iconSubmit.sprite = listIconSubmit[1];
            iconSubmit.gameObject.GetComponent<UIButton>().interactable = true;
