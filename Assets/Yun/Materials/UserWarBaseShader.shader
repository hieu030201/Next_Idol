...
Shader "Toony Colors Pro 2/User/WarBaseShader"
{
	Properties
	{
		[TCP2HeaderHelp(Base)]
...
/* TCP_DATA u config(ver:"2.9.6";unity:"2022.3.20f1";tmplt:"SG2_Template_Default";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2019_4","UNITY_2020_1","UNITY_2021_1","UNITY_2021_2","UNITY_2022_2","TEXTURE_RAMP","TEXTURE_RAMP_SLIDERS","TEXTURE_RAMP_2D"];flags:list["noforwardadd"];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[NoScaleOffset]",RampTextureLabel="2D Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 743768209278b4a1c127e1674389e0f0 */
