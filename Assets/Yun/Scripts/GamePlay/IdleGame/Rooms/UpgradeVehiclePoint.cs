...
{
    public class UpgradeVehiclePoint : YunBehaviour
    {
        ...
        public int DepositNumber
        {
            ...
            set
            {
                if (_depositNumber != value)
                {
                    ...
                    // Debug.Log("DepositNumber: " + percent + ", " + newZ);
        ...
        protected override void Awake()
        {
            ...
            {
                transform.Find("Build_Point_Background_4").Find("point1").gameObject,
                transform.Find("Build_Point_Background_4").Find("point2").gameObject,
                transform.Find("Build_Point_Background_4").Find("point3").gameObject
            };
